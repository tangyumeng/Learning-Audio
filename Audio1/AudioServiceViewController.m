...
#import "AudioServiceViewController.h"
...
@interface AudioServiceViewController ()
{
    
}
@end

@implementation AudioServiceViewController
...
{
    // Create status label
    labelStatus = [[UILabel alloc] initWithFrame: CGRectMake(10, 150, 300, 30)];
    ...
    buttonRecord.frame = CGRectMake(6.0, 220.0, 140, 35);
    ...
    buttonPlay.frame = CGRectMake(161.0,220.0, 140, 35);
